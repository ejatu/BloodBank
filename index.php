            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-user"></i> Do you want to Donate Blood?</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <a href="Donor_reg.php" class="btn btn-primary">Donate Now!</a>
                    </div>
                </div>
            </div>
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-medkit"></i> Do you need Blood?</h4>
                    </div>
                    <div class="panel-body">
